...
//+kubebuilder:rbac:groups=devsec.scriptonbasestar.com,resources=vaults,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=devsec.scriptonbasestar.com,resources=vaults/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=devsec.scriptonbasestar.com,resources=vaults/finalizers,verbs=update
