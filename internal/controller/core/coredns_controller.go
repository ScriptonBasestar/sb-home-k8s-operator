...
//+kubebuilder:rbac:groups=core.scriptonbasestar.com,resources=coredns,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=core.scriptonbasestar.com,resources=coredns/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=core.scriptonbasestar.com,resources=coredns/finalizers,verbs=update
