...
//+kubebuilder:rbac:groups=core.scriptonbasestar.com,resources=traefiks,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=core.scriptonbasestar.com,resources=traefiks/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=core.scriptonbasestar.com,resources=traefiks/finalizers,verbs=update
