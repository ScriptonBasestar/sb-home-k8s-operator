...
//+kubebuilder:rbac:groups=monitor.scriptonbasestar.com,resources=dashboards/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=monitor.scriptonbasestar.com,resources=dashboards/finalizers,verbs=update
