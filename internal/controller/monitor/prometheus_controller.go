...
//+kubebuilder:rbac:groups=monitor.scriptonbasestar.com,resources=prometheuses,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=monitor.scriptonbasestar.com,resources=prometheuses/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=monitor.scriptonbasestar.com,resources=prometheuses/finalizers,verbs=update
...
func (r *PrometheusReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&monitorv1alpha1.Prometheus{}).
		Complete(r)
}
